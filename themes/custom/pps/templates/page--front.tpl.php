...
<div id="page">
	...
	<?php print render($page['fp_carousel']); ?>
	<?php print render($page['masthead']); ?>
	<?php print render($page['pre_content']); ?>

	<?php print render($page['content']['metatags']); // needed since there is no content section ?>
	<?php print $messages; ?>
	<?php print render($page['help']); ?>

	<?php print render($page['post_content_white']); ?>
	<?php print render($page['fp_people_carousel']); ?>
